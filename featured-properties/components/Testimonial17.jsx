      ...
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">
            Real words from those who found their place
          </p>
        </div>
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            <div className="rb-5 mb-5 md:mb-6">
              ...
              <blockquote className="md:text-md">
                "They understood what I was looking for before I could fully
                explain it. The process was clean and honest."
              </blockquote>
            </div>
          ...
          <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            <div className="rb-5 mb-5 md:mb-6">
              ...
              <blockquote className="md:text-md">
                "Found the perfect home in half the time I expected. No
                pressure, just good guidance."
              </blockquote>
            </div>
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              <img
          ...
          <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            <div className="rb-5 mb-5 md:mb-6">
              ...
              <blockquote className="md:text-md">
                "They handled everything with care. This team knows the market
