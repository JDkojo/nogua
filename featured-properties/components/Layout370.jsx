        ...
        <div className="rb-12 mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <p className="md:text-md">
              Location matters. These are the addresses that hold their weight.
            </p>
          </div>
        </div>
            ...
            <div className="flex flex-col border border-border-primary">
              ...
              <div className="flex flex-col justify-center p-6">
                <div>
                  ...
                  <p>
                    Established neighborhoods with proven appreciation and solid
                    bones.
                  </p>
                </div>
            ...
            <div className="grid grid-cols-1 border border-border-primary sm:col-span-2 sm:row-span-1 sm:grid-cols-2">
              ...
              <div className="flex flex-1 flex-col justify-center p-6">
                <div>
                  ...
                  <h3 className="mb-2 text-xl font-bold md:text-2xl">
                    Features that make a difference in daily life
                  </h3>
                  <p>
                    Built-in quality. Pools, gardens, views, and spaces designed
                    for living well.
                  </p>
                </div>
