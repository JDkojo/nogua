                    ...
                    <div className="grid flex-1 gap-x-8 gap-y-6 py-4 pr-8 md:grid-cols-2 md:px-0 md:py-8 lg:py-8 lg:pr-8">
                      <div className="grid auto-rows-max grid-cols-1 grid-rows-[max-content] gap-y-2 md:gap-y-4">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Residential sales</h5>
                            <p className="hidden text-sm md:block">
                              Find your next home with our curated selection of
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">
                              Discover prime commercial spaces designed for your
                              business growth
                            </h5>
                            <p className="hidden text-sm md:block">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            ...
                            <p className="hidden text-sm md:block">
                              Professional management services for your
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            ...
                            <p className="hidden text-sm md:block">
                              Expert guidance to maximize your real estate
                              investment returns
                            </p>
                          </div>
                        </a>
                      ...
                      <div className="grid auto-rows-max grid-cols-1 grid-rows-[max-content] gap-y-2 md:gap-y-4">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">New launches</h5>
                            <p className="hidden text-sm md:block">
                              Explore the latest developments hitting the market
                            </p>
                          </div>
                        </a>
                        <a
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Luxury properties</h5>
                            <p className="hidden text-sm md:block">
                              Experience premium living in our exclusive luxury
                              collection
                            </p>
                          </div>
                        </a>
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Map view</h5>
                            <p className="hidden text-sm md:block">
                              Browse properties by location on our interactive
                              map
                            </p>
                          </div>
                        </a>
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Book site visit</h5>
                            <p className="hidden text-sm md:block">
                              Schedule your property viewing at a time that
                              works for you
                            </p>
                          </div>
                        </a>
                        ...
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[auto_auto] items-start gap-y-2 lg:grid-rows-[auto]">
                          ...
                          >
                            ...
                            <div className="rt-4 mt-4 flex flex-col justify-start md:mt-0">
                              ...
                              <p className="text-sm">
                                Stay informed with our latest real estate market
                                analysis
                              </p>
                          ...
                          >
                            ...
                            <div className="rt-4 mt-4 flex flex-col justify-start md:mt-0">
                              ...
                              <p className="text-sm">
                                Learn proven approaches to building your
                                property portfolio
                              </p>
                              <div className="mt-1.5">
                                <Button
