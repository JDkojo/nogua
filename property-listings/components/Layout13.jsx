        ...
        <div className="grid grid-cols-1 gap-y-12 md:grid-flow-row md:grid-cols-2 md:items-center md:gap-x-12 lg:gap-x-20">
          <div>
            ...
            <p className="mb-5 md:mb-6 md:text-md">
              Ask questions about any listing instantly. Our team responds
              quickly to help you schedule viewings and get property details.
            </p>
          ...
          <div>
            <img
              ...
              alt="Agent consulting with property buyers"
              loading="lazy"
              width={1200}
              height={800}
            />
