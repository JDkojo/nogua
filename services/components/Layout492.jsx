      ...
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">
            Owning property takes time. We handle the work so you collect the
            returns. Tenant screening, repairs, rent collection, and reporting
            all fall to us.
          </p>
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  We vet every applicant thoroughly. Background checks, income
                  verification, and rental history give you peace of mind.
                </p>
              </motion.div>
            </div>
            <div
