      ...
      <div className="container">
        <div className="rb-12 mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <p className="md:text-md">Beyond the initial strategy</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:gap-8 lg:grid-cols-4">
            <div className="grid grid-cols-1 border border-border-primary sm:col-span-2 sm:row-span-1 sm:grid-cols-2">
              <div className="flex flex-1 flex-col justify-center p-6">
                <div>
                  <p className="mb-2 text-sm font-semibold">Diversify</p>
                  <h3 className="mb-2 text-xl font-bold md:text-2xl">
                    Spread risk across property types
                  </h3>
                  <p>
                    We help you balance residential, commercial, and alternative
                    investments.
                  </p>
                </div>
            ...
            <div className="flex flex-col border border-border-primary">
              <div className="flex flex-col justify-center p-6">
                <div>
                  <p className="mb-2 text-sm font-semibold">Forecast</p>
                  <h3 className="mb-2 text-xl font-bold md:text-2xl">
                    See the numbers ahead
                  </h3>
                  <p>
                    ROI projections based on market data and your specific
                    situation.
                  </p>
                </div>
