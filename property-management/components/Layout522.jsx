        ...
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <h2 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
              What ownership should feel like
            </h2>
            <p className="md:text-md">
              Professional management means real money in your pocket and real
              peace in your mind.
            </p>
          </div>
        </div>
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:gap-8 lg:grid-cols-4">
          <div className="relative p-6 sm:col-span-2 md:p-8 lg:p-12">
            ...
            <div className="relative z-10">
              ...
              <h3 className="mb-5 text-4xl font-bold leading-[1.2] text-text-alternative md:mb-6 md:text-5xl lg:text-6xl">
                Sleep soundly knowing your investment is secure
              </h3>
              <p className="text-text-alternative">
                We handle the problems so you don't have to think about them at
                all.
              </p>
          ...
          <div className="relative flex flex-col p-6 md:p-8 lg:p-6">
            ...
            <div className="relative z-10 flex flex-1 flex-col justify-between">
              ...
              <h3 className="mb-2 text-xl font-bold text-text-alternative md:text-2xl">
                Higher returns on your capital
              </h3>
              <p className="text-text-alternative">
                Better tenants and faster rent mean better numbers on your
                statements.
              </p>
          ...
          <div className="relative flex flex-col p-6 md:p-8 lg:p-6">
            ...
            <div className="relative z-10 flex flex-1 flex-col justify-between">
              ...
              <h3 className="mb-2 text-xl font-bold text-text-alternative md:text-2xl">
                Properties stay occupied and profitable
              </h3>
              <p className="text-text-alternative">
                Vacant units cost money. We keep them filled with quality
                tenants.
              </p>
              <div className="mt-5 flex items-center md:mt-6">
                <Button
