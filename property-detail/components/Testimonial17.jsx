    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">What people who live here say</p>
        </div>
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            <div className="rb-5 mb-5 md:mb-6">
              ...
              <blockquote className="md:text-md">
                "The light comes through these windows like nothing I've ever
                seen before. It's honest and clean."
              </blockquote>
            </div>
          ...
          <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            <div className="rb-5 mb-5 md:mb-6">
              ...
              <blockquote className="md:text-md">
                "We raised our family here. The neighborhood has character, real
          ...
          <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            <div className="rb-5 mb-5 md:mb-6">
              ...
              <blockquote className="md:text-md">
                "This place holds its value. That matters when you're building
