    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">What those who know quality have to say</p>
        </div>
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            <div className="rb-5 mb-5 md:mb-6">
              ...
              <blockquote className="md:text-md">
                "The attention to detail was remarkable. They understood what I
                wanted before I had to say it."
              </blockquote>
            </div>
          ...
          <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            <div className="rb-5 mb-5 md:mb-6">
              ...
              <blockquote className="md:text-md">
                "Finding the right property felt effortless. Their knowledge of
            ...
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              ...
              />
              <div>
                <p className="font-semibold">Catherine Wells</p>
          ...
          <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
            <div className="rb-5 mb-5 md:mb-6">
              ...
              <blockquote className="md:text-md">
                "This team doesn't just sell homes. They understand the life you
                want to live."
              </blockquote>
            </div>
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              ...
              />
              <div>
                <p className="font-semibold">Richard Ashford</p>
                <p>Entrepreneur, technology</p>
              </div>
            </div>
          </div>
        </div>
