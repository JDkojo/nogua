      ...
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">
            Real ratings from real transactions across our platform
          </p>
        </div>
        <Carousel
            ...
            <CarouselContent className="ml-0 md:mx-3.5">
              <CarouselItem className="pl-0 md:basis-1/2 md:px-4 lg:basis-1/3">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <p className="md:text-md">
                    "Sold my commercial space faster than I thought possible.
                    Their network is impressive."
                  </p>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    ...
                    <div>
                      ...
                      <p>Commercial property seller</p>
                    </div>
                  </div>
                </div>
              </CarouselItem>
