        ...
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-2 md:items-center md:gap-x-12 lg:gap-x-20">
          <div>
            ...
            <p className="mb-5 md:mb-6 md:text-md">
              Have questions about a property or need advice? Reach out
              directly. We respond fast and speak plainly about what matters to
              you.
            </p>
            <ul className="my-4 list-disc pl-5">
              <li className="my-1 self-start pl-2">
                <p>Real-time answers to your questions</p>
              </li>
              <li className="my-1 self-start pl-2">
                <p>No waiting, no runaround, just honest conversation</p>
              </li>
              <li className="my-1 self-start pl-2">
